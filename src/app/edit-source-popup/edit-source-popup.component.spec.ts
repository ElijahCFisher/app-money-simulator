...
describe('EditSourcePopupComponent', () => {
...
describe('EditSourcePopupComponent for ScenarioSettings', () => {
  let component: EditSourcePopupComponent;
  let fixture: ComponentFixture<EditSourcePopupComponent>;
  ...
  beforeEach(async () => {
    ...
    fixture = TestBed.createComponent(EditSourcePopupComponent);
    component = fixture.componentInstance;
    component.componentAsJson = Funcs.sourceFromJson(sources1ScenarioSettings, 0).ownJson();
    fixture.detectChanges();
  });
  ...
  it('should not have popupName', () => {

    const compiled = fixture.nativeElement as HTMLElement;
    const name = compiled.querySelector('#popupName');
  ...
  it('should not editSource when json not changed', () => {
    spyOn(component, 'closePopupEvent');
  ...
  it('should not have delete button', () => {
    ...
    const compiled = fixture.nativeElement as HTMLElement;
    const deleteButton = compiled.querySelector('#deleteButton');
